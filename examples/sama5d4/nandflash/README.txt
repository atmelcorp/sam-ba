...
The following commands are equivalent to the nandflash-jlink.qml script:
        ...
        sam-ba -p jlink -b sama5d4-xplained -a nandflash -c erase
        sam-ba -p jlink -b sama5d4-xplained -a nandflash -c writeboot:at91bootstrap-sama5d4_xplained.bin
        sam-ba -p jlink -b sama5d4-xplained -a nandflash -c write:u-boot-sama5d4-xplained.bin:0x40000
        sam-ba -p jlink -b sama5d4-xplained -a nandflash -c write:u-boot-env-sama5d4-xplained.bin:0xc0000
        sam-ba -p jlink -b sama5d4-xplained -a nandflash -c write:at91-sama5d4_xplained.dtb:0x180000
        sam-ba -p jlink -b sama5d4-xplained -a nandflash -c write:zImage-sama5d4-xplained.bin:0x200000
        sam-ba -p jlink -b sama5d4-xplained -a nandflash -c write:atmel-xplained-demo-image-sama5d4-xplained.ubi:0x800000
