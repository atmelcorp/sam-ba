...
The following commands are equivalent to the nandflash-usb.qml script:
        ...
        sam-ba -p serial -b sam9x60-ek -a nandflash -c write:u-boot-env.bin:0x4000
        sam-ba -p serial -b sam9x60-ek -a nandflash -c write:u-boot.bin:0x8000
        sam-ba -p serial -b sam9x60-ek -a nandflash -c write:sam9x60_ek.dtb:0x60000
        sam-ba -p serial -b sam9x60-ek -a nandflash -c write:zImage:0x6c000
...
The following commands are equivalent to the nandflash-jlink.qml script:
        ...
        sam-ba -p j-link -b sam9x60-ek -a nandflash -c erase
        sam-ba -p j-link -b sam9x60-ek -a nandflash -c writeboot:at91bootstrap.bin
        sam-ba -p j-link -b sam9x60-ek -a nandflash -c write:u-boot-env.bin:0x4000
        sam-ba -p j-link -b sam9x60-ek -a nandflash -c write:u-boot.bin:0x8000
        sam-ba -p j-link -b sam9x60-ek -a nandflash -c write:sam9x60_ek.dtb:0x60000
        sam-ba -p j-link -b sam9x60-ek -a nandflash -c write:zImage:0x6c000
