...
The following commands are equivalent to the serialflash-usb.qml script:
        ...
        sam-ba -p serial -b sam9x60-ek -a serialflash -c erase
        sam-ba -p serial -b sam9x60-ek -a serialflash -c writeboot:at91bootstrap.bin
        sam-ba -p serial -b sam9x60-ek -a serialflash -c write:u-boot-env.bin:0x4000
        sam-ba -p serial -b sam9x60-ek -a serialflash -c write:u-boot.bin:0x8000
        sam-ba -p serial -b sam9x60-ek -a serialflash -c write:sam9x60_ek.dtb:0x60000
        sam-ba -p serial -b sam9x60-ek -a serialflash -c write:zImage:0x6c000
...
The following commands are equivalent to the serialflash-jlink.qml script:
        ...
        sam-ba -p j-link -b sam9x60-ek -a serialflash -c erase
        sam-ba -p j-link -b sam9x60-ek -a serialflash -c writeboot:at91bootstrap.bin
        sam-ba -p j-link -b sam9x60-ek -a serialflash -c write:u-boot-env.bin:0x4000
        sam-ba -p j-link -b sam9x60-ek -a serialflash -c write:u-boot.bin:0x8000
        sam-ba -p j-link -b sam9x60-ek -a serialflash -c write:sam9x60_ek.dtb:0x60000
        sam-ba -p j-link -b sam9x60-ek -a serialflash -c write:zImage:0x6c000
