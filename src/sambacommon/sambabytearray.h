...
public:
	...
	explicit SambaByteArray(unsigned length);
	...
	Q_INVOKABLE quint16 readu16(unsigned offset) const;
	Q_INVOKABLE void writeu16(unsigned offset, quint16 value);
	Q_INVOKABLE quint32 readu32(unsigned offset) const;
	Q_INVOKABLE void writeu32(unsigned offset, quint32 value);
